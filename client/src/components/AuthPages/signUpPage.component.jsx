            ...
            <div className="text-black mx-1">
                ...
                <div className="my-6">
                    <div className="mb-4">
                        ...
                        <input type="text" placeholder="eg: Katy Ceren" className=" w-full text-xl mt-2 py-2 px-3 rounded focus:outline-bms-100 text-black" required />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="text-xl">Official Email</label> <br />
                        <input type="email" placeholder="eg: 00ABC000@cuchd.in" className=" w-full text-xl mt-2 py-2 px-3 rounded focus:outline-bms-100 text-black" required />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="username" className="text-xl">UID</label> <br />
                        <input type="text" placeholder="eg: ikayc96#" className=" w-full text-xl mt-2 py-2 px-3 rounded focus:outline-bms-100 text-black" required />
                    </div>
                    <div className="mb-6">
