                ...
                <div className="text-white mx-20 my-2 flex justify-center items-center gap-9">
                    ...
                    <div>
                        <div className="order-1 w-full mt-16">
                            ...
                            <div className="flex">
                                <div className="mb-2">
                                    <span><div className="text-white">Already have an account? <span className="cursor-pointer hover:font-semibold underline underline-offset-4 transition-all ease-in-out delay-150 " onClick={() => navigate("/signin")}>Sign In</span></div></span>
