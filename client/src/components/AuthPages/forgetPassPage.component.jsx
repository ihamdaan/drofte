                        ...
                        <div className='lg:order-1'>
                            ...
                            <div>
                                <form className="my-2" onSubmit={handleSubmit}>
                                    <div className="mb-6">
                                        <input type="email" placeholder="eg: 00ABC00@cuchd.in" className=" w-full text-black text-2xl md:text-xl mt-2 py-2 px-3 rounded focus:outline-bms-100" required name="email" value={email} onChange={(e) => setEmail(e.target.value)} />
                                    </div>
